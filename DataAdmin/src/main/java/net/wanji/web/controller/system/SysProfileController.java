...
import net.wanji.framework.config.ServerConfigLocalhost;
...
public class SysProfileController extends BaseController
{
    ...
    @Autowired
    private ServerConfigLocalhost serverConfigLocalhost;
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String url = serverConfigLocalhost.getUrl();
            String avatar = FileUploadUtils.upload(WanjiConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
            if (userService.updateUserAvatar(loginUser.getUsername(), url+avatar))
            {
                AjaxResult ajax = AjaxResult.success();
                ajax.put("imgUrl", url+avatar);
                // 更新缓存用户头像
                loginUser.getUser().setAvatar(url+avatar);
                tokenService.setLoginUser(loginUser);
                return ajax;
            }
        }
