...
import net.wanji.common.exception.user.CaptchaException;
import net.wanji.common.exception.user.CaptchaExpireException;
...
public class SysLoginService {
     ...
     * @return 结果
     */
    public String login(String username, String password, String code, String uuid, String platformType) {
        boolean captchaEnabled = configService.selectCaptchaEnabled();
        // 验证码开关
        if (captchaEnabled && "web".equals(platformType)) {
